...
{
    private MonthResolver $months;

    private SchemaFilterMatcher $matcher;

    private CoefficientResolver $coefficients;

    private OfferFactory $offers;

    private PreferredOfferSelector $selector;

    private FirstInstallmentResolver $firstInstallment;

    private FinancialCalculator $financial;
    ...
    public function calculate(
        ...
        int $months,
        string $type,
        float $requestedFirstInstallment = 0.0,
        int $filterId = 0
    ): CalculationResult {
