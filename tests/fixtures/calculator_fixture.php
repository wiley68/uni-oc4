...
function mt_uni_credit_calculator_fixture(array $overrides = []): array
{
    $shop = [
        'uni_status'        => 1,
        'uni_minstojnost'   => 100,
...
function mt_uni_credit_schema_filters_fixture(): array
{
    return [
        [
            'id'            => 10,
        ...
        [
            ...
            'uni_promo'     => 1,
            'uni_parva'     => 0,
            'uni_date_from' => '2026-08-17',
            'uni_date_to'   => '2026-08-17',
            'uni_kop'       => 'ZERO',
...
function mt_uni_credit_cart_line(
    int $productId,
    array $categoryIds,
    float $cartTotal,
    int $quantity = 1,
    float $lineTotal = 0.0
): \Opencart\System\Library\Extension\MtUniCredit\CartLine {
    return new \Opencart\System\Library\Extension\MtUniCredit\CartLine(
        new \Opencart\System\Library\Extension\MtUniCredit\ProductContext($productId, $categoryIds, $cartTotal),
        0,
        $quantity,
        $lineTotal > 0 ? $lineTotal : $cartTotal
    );
}
