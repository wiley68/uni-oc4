...
spl_autoload_register(static function (string $class): void {
    ...
    if (str_ends_with($relative, 'Exception')) {
        foreach (['persistence_exception.php', 'cp_exception.php', 'shop_snapshot_validation_exception.php', 'unavailable_scheme_exception.php', 'order_materialization_exception.php'] as $exceptionFile) {
