...
spl_autoload_register(static function (string $class): void {
    ...
    if (str_ends_with($relative, 'Exception')) {
        foreach ([
            'persistence_exception.php',
            'cp_exception.php',
            'certificate_sync_exception.php',
            'shop_snapshot_validation_exception.php',
            'unavailable_scheme_exception.php',
            'order_materialization_exception.php',
            'product_financing_flow_exception.php',
            'module_api_exception.php',
            'smart_ucf_session_exception.php',
            'financing_order_ambiguous_exception.php',
            'order_bank_status_semantic_conflict_exception.php',
        ] as $exceptionFile) {
